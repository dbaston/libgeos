...
void object::test<12>()
{
    auto shell_seq = geos::detail::make_unique<CoordinateSequence>(CoordinateSequence{{0, 0}, {0, 10}, {3, 10}, {3, 0}, {0, 0}});
    auto hole_1_seq = geos::detail::make_unique<CoordinateSequence>(CoordinateSequence{{1, 1}, {2, 1}, {2, 2}, {1, 2}, {1, 1}});
    auto hole_2_seq = geos::detail::make_unique<CoordinateSequence>(CoordinateSequence{{1, 8}, {1, 9}, {2, 9}, {2, 8}, {1, 8}});
